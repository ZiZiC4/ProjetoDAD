<template>
    <div>
        ...
        <!--<user-list
            ...
            @edit-click="editUserClick"
            @delete-click="deleteUserClick"
        ></user-list>
       
        <user-edit
            :user="currentUser"
            v-on:user-saved="saveUserClick"
            @user-canceled="cancelEditClick"
            v-if="editingUser"
        ></user-edit>-->
